...
<div class="view-food-item-wrap">
	...
	<div class="rp-col-md-12 md-12-top special-inst <?php echo $color; ?>">
		...
		<textarea placeholder="Add Instructions.." class="rp-col-md-12 special-instructions" name="special_instruction">{cartinstructions}</textarea>
	</div>
	<?php endif; ?>
</div>
