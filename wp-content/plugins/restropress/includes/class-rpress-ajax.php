  ...
  */
  ...
  public static function update_cart_items() {
   ...
   // check_ajax_referer( 'update-cart-item', 'security' );
    ...
    $fooditem_id = isset( $_POST['fooditem_id'] ) ? $_POST['fooditem_id'] : '';
    $item_qty = isset( $_POST['fooditem_qty'] ) ? $_POST['fooditem_qty'] : '';
    ...
    $item_key = rpress_add_to_cart( $fooditem_id, $options );
    ...
    $item   = apply_filters( 'rpress_ajax_pre_cart_item_template', $item );
    $items .= rpress_get_cart_item_template( $item_key, $item, true, $cart_key );
