...
function rpress_get_cart_discounts_html( $discounts = false ) {
	...
	foreach ( $discounts as $discount ) {
		...
		$total     = rpress_get_cart_total( $discount );
        $discount_value = rpress_get_discount_value( $discount, $total );
 ...
 */
function rpress_get_discount_value( $discount, $calculated_discount ) {
