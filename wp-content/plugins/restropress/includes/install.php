...
/**
 * Migrate database at the time of update
 *
 * @since  2.6
 * @return mixed
 */
// function rpress_upgrade_migration( $upgrader_object, $options ) {

//   if ( $options['action'] == 'update' && $options['type'] == 'plugin' ){
//   	foreach ( $options['plugins'] as $plugin ) {
//     	if ( $plugin == 'restropress/restro-press.php' ){
...
//   }
// }
// add_action( 'upgrader_process_complete', 'rpress_upgrade_migration', 10, 2 );
