      ...
      foreach( $prices as $k => $price ) {
        ...
        <div class="food-item-list">
          <label for="<?php echo $price_option_slug; ?>" class="radio-container">
            <input type="radio" name="price_options" id="<?php echo $price_option_slug; ?>" value="<?php echo $k; ?>" <?php echo $is_first; ?> class="rp-variable-price-option" ><?php echo $price_option; ?>
