...
function rpress_order_notification_settings_callback( $args ) {
    ...
    <table class="rpress_emails widefat" cellspacing="0">
        ...
        <tbody>
            <?php
                ...
                echo '<td>';
                echo __( 'Admin Order Notification', 'restropress' );
                echo '</td>';
    ...
    <?php
    $order_status = !empty( $_GET['rpress_order_status'] ) ?  strtolower( $_GET['rpress_order_status'] ) : '';
  $order_statuses = rpress_get_order_statuses();
    ...
    <div class="rpress_email_field_settings_wrapper">
      <h2><?php echo $status; ?>
        <small class="rpress-admin-breadcrumb">
          <a href="<?php echo admin_url( 'admin.php?page=rpress-settings&tab=emails&section=order_notifications'); ?>">⤴</a>
        </small>
      </h2>
      ...
      <table>
        <tr>
          <td>
            <label for="enable_disable">
              <?php echo __( 'Enable/Disable', 'restropress' ); ?>
            </label>
          </td>
          <td>
            <label for="enable_disable">
              <input id="enable_disable" <?php echo $enable_notification; ?> value="yes" type="checkbox" name="<?php echo 'rpress_settings['.$order_status.'][enable_notification]'; ?>">
              <?php echo __( 'Enable this email notification', 'restropress' ); ?>
            </label>
          </td>
        </tr>
        ...
        <tr>
          <td>
            <label for="admin_recipients">
              <?php echo __( 'Recipient(s)', 'restropress' ); ?>
            </label>

          </td>
          <td>
            <textarea class="large-text" rows="5" cols="50" id="admin_recipients" name="<?php echo 'rpress_settings['.$order_status.'][admin_recipients]'; ?>"><?php echo $email_recipients; ?></textarea>
            <span class="help-text"><?php echo __( 'Enter the email address(es) that should receive a notification anytime a order is placed, one per line.', 'restropress' ); ?></span>
          </td>
        ...
        <tr>
          <td>
            <label for="subject">
              <?php echo __( 'Subject', 'restropress' ); ?>
            </label>
          </td>
          <td>
            <input id="subject" type="text" name="<?php echo 'rpress_settings['.$order_status.'][subject]'; ?>" value="<?php echo $email_subject; ?>">
          </td>
        </tr>
        ...
        <tr>
          <td>
            <label for="email_heading">
              <?php echo __( 'Email heading', 'restropress' ); ?>
            </label>
          </td>
          <td>
            <input id="email_heading" type="text" name="<?php echo 'rpress_settings['.$order_status.'][heading]'; ?>" value="<?php echo $email_heading; ?>">
          </td>
        ...
        <tr>
          <td class="email_content">
            <label for="email_content">
              <?php echo __( 'Email Content', 'restropress' ); ?>
            </label>
          </td>
          <td class="email_message_contents">
            ...
            ?>
            <label for="email_content">
              <?php echo __('Enter the text that is sent as order notification email. HTML is accepted. Available template tags:','restropress' ) . '<br/>' . rpress_get_emails_tags_list(); ?>
            </label>
