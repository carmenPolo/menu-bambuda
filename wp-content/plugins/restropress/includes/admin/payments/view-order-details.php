...
<div class="wrap rpress-wrap">
		...
		<div class="inside">
			<div class="rpress-admin-box">
				...
				<div class="rpress-admin-box-inside">
					...
					<p>
						<span class="label"><?php _e( 'Payment:', 'restropress' ); ?></span>
					...
					<div class="rpress-admin-box-inside">
						<p class="rpress-order-fees strong">
							<span class="label"><?php _e( 'Fees:', 'restropress' ); ?></span>
					...
					<div class="rpress-admin-box-inside">
							<p class="rpress-order-taxes">
								<span class="label"><?php echo rpress_get_tax_name(); ?>:</span>
					...
					<?php if ( !empty( $discount ) ) : ?>
						<div class="rpress-admin-box-inside">
							<p class="rpress-order-discount">
								<span class="label"><?php _e( 'Coupon', 'restropress' ); ?>:</span>&nbsp;
								<?php echo $discount; ?>
							</p>
						</div>
					<?php endif; ?>
	...
	<div id="rpress-order-details" class="postbox rpress-order-data rpress-payment-info-wrap">
		<h3 class="hndle">
			<span><?php _e( 'Payment Info', 'restropress' ); ?></span>
		</h3>
		<div class="inside">
				...
				<?php do_action( 'rpress_view_order_details_payment_meta_before', $payment_id ); ?>
					...
					<div class="rpress-admin-box-inside">
						<p class="rpress-order-payment-key">
							<span class="label"><?php _e( 'Key:', 'restropress' ); ?></span><?php echo $payment->key; ?>
						</p>
					</div>
			...
			<div class="rpress-admin-box">
				<div class="rpress-admin-box-inside">
					<p>
						...
						<a class="customer-order-logs" href="<?php echo $purchase_url; ?>"><?php _e( 'View all orders for this customer', 'restropress' ); ?></a>
					</p>
				</div>
					...
					<div class="column">
						...
						<div class="rpress-delivery-details">
							<p class="rp-service-details">
								<strong><?php _e( 'Service type: ', 'restropress' ); ?></strong><?php //echo rpress_service_label( $service_type ); ?>
							...
							<div class="rpress-delivery-details">
								<p class="rp-service-time">
									...
									<select name="rp_service_time" class="medium-text">
				                        <?php echo rp_get_store_service_hours('pickup', false, $service_time ); ?>
				                    </select>
								</p>
							</div>
						<?php endif; ?>
                ...
                foreach ( $cart_items as $key => $cart_item ) :
                    ...
                    <div class="row rpress-purchased-row">
                      	...
                      	<div class="rpress-order-items-wrapper">
                      		<ul class="rpress-purchased-items-list-wrapper <?php echo $key; ?>">
                      			<li class="fooditem">
                      				<span class="rpress-purchased-fooditem-actions actions">
		                                ...
		                                <a href="" class="rpress-order-remove-fooditem rpress-delete" data-key="<?php echo esc_attr( $key ); ?>"><?php _e( '&times;', 'restropress' ); ?></a>
		                            </span>
                  				...
                  				<li class="item_price">
                  					...
                  					<span class="rpres-order-quantity-wrap">
                  						...
                  						<input type="number" name="rpress-payment-details-fooditems[<?php echo $key; ?>][quantity]" class="small-text rpress-payment-details-fooditem-quantity rpress-payment-item-input rpress-order-input" min="1" step="1" value="<?php echo $quantity; ?>" />
                  					</span>
                  				</li>
	...
	<div class="food-item-list">
						...
						foreach( $addon_items as $key => $addon_item ) :
							...
							if ( is_array($get_addons) && !empty( $get_addons ) ) :
								foreach( $get_addons as $get_addon ) :
									...
									if ( !empty( $selected_addon_items ) ) {
										foreach( $selected_addon_items as $selected_addon_item ) {
											...
											if ( $selected_addon_id == $addon_item_id ) { ?>
												<option selected data-price="<?php echo $addon_price; ?>" data-id="<?php echo $addon_item_id; ?>" value="<?php echo $addon_item_name . '|' . $addon_item_id . '|' . $addon_price .'|'. '1' ; ?>">
                                    ...
                                    <option data-price="<?php echo $addon_price; ?>" data-id="<?php echo $addon_item_id; ?>" value="<?php echo $addon_item_name . '|' . $addon_item_id . '|' . $addon_price .'|'. '1' ; ?>">
                                        <?php echo $addon_item_name . ' (' . $addon_price . ') '; ?>
                                    </option>
                                <?php endforeach;
                            endif;
        ...
        <div class="postbox rpress-edit-purchase-element rp-add-update-elements <?php echo $column_count; ?>">
