          ...
          <tbody>
            ...
            foreach( $order_items as $fooditems ) :
              ...
              if ( isset( $fooditems['name'] ) ) :
                ...
                $price      = isset( $fooditems['item_price'] ) ? $fooditems['item_price'] : false;
                $item_qty   = isset( $fooditems['quantity'] ) ? $fooditems['quantity'] : false;
              ?>
            <tr class="rp-order-preview-table">
              ...
              <td class="rp-order-preview-table__column--price">
                <?php echo rpress_currency_filter(rpress_format_amount( $price * $item_qty )); ?>
              </td>
            </tr>
              ...
              if ( is_array( $fooditems['item_number']['options'] ) ) :
                foreach( $fooditems['item_number']['options'] as $addon_items ) :
                  if( is_array( $addon_items ) ) :
                    ...
                    $addon_price = empty( $addon_items['price'] ) ? 0 : $addon_items['price'];
                  ?>
                    <tr class="rp-order-addons">
                      ...
                      <?php endif; ?>
                      <td>
                        <?php echo rpress_currency_filter( rpress_format_amount( $addon_price * $fooditems['quantity'] ) ); ?>
                      </td>
                    </tr>
                    <?php
                  endif;
