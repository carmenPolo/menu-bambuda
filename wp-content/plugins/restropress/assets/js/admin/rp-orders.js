jQuery( function( $ ) {
  ...
  */
  jQuery( document ).on( 'change', '#rpress-payments-filter .rp_order_status', function(e) {
    e.preventDefault();
    var _self = jQuery( this );
    var selectedStatus = _self.val();
    var currentStatus = _self.data( 'current-status' );
    $payment_id = _self.data( 'payment-id' );
